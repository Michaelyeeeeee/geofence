...
if __name__ == '__main__':
    ...
    latitude_avg, longitude_avg = get_gps_location(gps_uart, lcd_uart)
    ...
    while True:
        ...
        latitude_avg, longitude_avg, velocity_x, velocity_y = imu_update(latitude_avg, longitude_avg,
                                                                         (time.ticks_ms() - imu_start_time) / 1_000,
